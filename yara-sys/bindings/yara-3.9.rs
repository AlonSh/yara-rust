...
>;
pub type YR_COMPILER = [u64; 1263usize];
extern "C" {
    #[link_name = "\u{1}_yr_compiler_create"]
    pub fn yr_compiler_create(compiler: *mut *mut YR_COMPILER) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_yr_compiler_destroy"]
    pub fn yr_compiler_destroy(compiler: *mut YR_COMPILER);
}
extern "C" {
    #[link_name = "\u{1}_yr_compiler_set_callback"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_set_include_callback"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_set_re_ast_callback"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_set_atom_quality_table"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_load_atom_quality_table"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_add_file"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_add_fd"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_add_string"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_get_error_message"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_get_current_file_name"]
    pub fn yr_compiler_get_current_file_name(
        compiler: *mut YR_COMPILER,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    #[link_name = "\u{1}_yr_compiler_define_integer_variable"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_define_boolean_variable"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_define_float_variable"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_define_string_variable"]
...
extern "C" {
    #[link_name = "\u{1}_yr_compiler_get_rules"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_scan_mem"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_scan_file"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_scan_fd"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_scan_proc"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_save_stream"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_load_stream"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_destroy"]
    pub fn yr_rules_destroy(rules: *mut YR_RULES) -> ::std::os::raw::c_int;
}
extern "C" {
    #[link_name = "\u{1}_yr_rules_define_integer_variable"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_define_boolean_variable"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_define_float_variable"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_define_string_variable"]
...
extern "C" {
    #[link_name = "\u{1}_yr_rules_print_profiling_info"]
    pub fn yr_rules_print_profiling_info(rules: *mut YR_RULES);
}
extern "C" {
    #[link_name = "\u{1}_yr_rules_get_stats"]
